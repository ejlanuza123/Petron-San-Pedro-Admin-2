...
export const validateOrderStatusUpdate = (currentStatus, newStatus) => {
  const validTransitions = {
    ...
    [ORDER_STATUS.PROCESSING]: [ORDER_STATUS.RIDER_PICKED_UP, ORDER_STATUS.CANCELLED],
    [ORDER_STATUS.RIDER_PICKED_UP]: [ORDER_STATUS.OUT_FOR_DELIVERY, ORDER_STATUS.CANCELLED],
